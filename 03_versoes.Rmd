...
versão para manter seu trabalho sempre sincronizado na núvem. Criar
...
knitr::include_graphics("static/03_pat.png")
```
...
versões do código e eviálas ao GitHub para que sejam armazenadas com segurança
na núvem.

```{r, echo=FALSE, fig.align='center', dpi=50}
knitr::include_graphics("static/03_git.png")
```
