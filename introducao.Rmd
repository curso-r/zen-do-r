...
- Pacotes: como e por que transformar um projeto em um pacote, como documentá-lo
...
extenso e já existem livros o suficiente para ajudar com isso (vide [o livro da Curso-R](https://livro.curso-r.com/) ou
...
Nada disso importa aqui; não vou dizer qual é o melhor jeito de programar^[E também não tenho paciência para entrar em mais nenhum debate "base vs.
tidyverse"].
