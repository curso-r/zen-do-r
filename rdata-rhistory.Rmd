...
IDE (*Integrated Development Environment*) que, em 90%^[Não tenho nenhuma estatística confiável sobre esse número, mas sei que ele
não é 100% porque conheço pelo menos uma pessoa que programa R no neovim.] dos casos, será o
RStudio.
