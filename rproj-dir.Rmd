...
importação vai exigir um caminho, uma string que representa oendereço do arquivo
...
Por fim, o til `~` é um caractere que indica a *home* do usuário (`/home/clente`
no meu caso) e costuma ser classificado como caminoh relativo.
