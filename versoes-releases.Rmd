...
Você, como pessoa que programa, quer poder fazer alterações no seu código que não
...
certa estabilidade. Por outro lado, a pessoa que usa também só quer atualizar seu
...
desenvolvimento é marcada como 9000, podendo chegar até 9999. Algumas pessoas que programam incrementam esse número a cada commit realizado, mas é mais comum
...
versão do seu pacote que deve ser baixada pelas pessoas. Depois basta ir para
